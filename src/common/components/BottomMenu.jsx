...
const BottomMenu = () => {
  ...
  return (
    <Paper 
      ...
      elevation={0}
      sx={{
        boxShadow: (theme) => theme.tokens?.shadows?.md || theme.shadows[4],
    ...
    >
      <BottomNavigation 
        ...
        showLabels
        sx={{
          transition: (theme) => theme.tokens?.transition?.base || 'all 250ms',
          '& .MuiBottomNavigationAction-root': {
            transition: (theme) => theme.tokens?.transition?.fast || 'all 150ms',
            '&.Mui-selected': {
      ...
      <Menu 
        ...
        sx={{
          '& .MuiMenu-paper': {
            borderRadius: (theme) => theme.tokens?.borderRadius?.sm || 8,
