...
// Initialize window references safely
const nativeEnvironment = typeof window !== 'undefined' ? (window.appInterface || (window.webkit && window.webkit.messageHandlers.appInterface)) : null;

export { nativeEnvironment };
...
// Setup window handlers in a safe way
...
const NativeInterface = () => {
  ...
  useEffectAsync(async () => {
    if (user && notificationToken && typeof window !== 'undefined') {
