...
import { getMapIcon } from '../map/core/preloadImages';
...
const useStyles = makeStyles()((theme) => ({
  icon: {
    width: '25px',
    height: '25px',
    filter: theme.palette.mode === 'dark' ? 'brightness(0) invert(1)' : 'brightness(0.2)',
  },
  batteryText: {
    fontSize: '0.75rem',
    fontWeight: 'normal',
  ...
  deviceRow: {
    ...
    margin: `${theme.tokens?.spacing ? theme.tokens.spacing(0.5) : theme.spacing(0.5)} 0`,
  ...
  return (
    <div style={style}>
      <ListItemButton
        ...
        className={selectedDeviceId === item.id ? classes.selected : classes.deviceRow}
      >
        <ListItemAvatar>
          <Avatar className={classes.avatar}>
            <img className={classes.icon} src={getMapIcon(item.category)} alt="" />
          </Avatar>
        </ListItemAvatar>
        <ListItemText
