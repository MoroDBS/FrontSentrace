                ...
                <FormControl fullWidth>
                  ...
                  <Select
                    ...
                    onChange={(e) => {
                      ...
                      if (value === 'auto') {
                        setAttributes({ ...attributes, darkMode: undefined });
                      } else {
                        setAttributes({ ...attributes, darkMode: value === 'dark' });
                      }
                    }}
                  >
                    <MenuItem value="auto">{t('sharedAuto')}</MenuItem>
                    <MenuItem value="light">{t('sharedLight')}</MenuItem>
                    <MenuItem value="dark">{t('sharedDark')}</MenuItem>
                  </Select>
                </FormControl>
              </AccordionDetails>
            </Accordion>
